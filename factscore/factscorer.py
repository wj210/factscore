...
class FactScorer(object):
    ...
    def print_cost_estimates(self, total_words, task, model):
        ...
        # if we use gpt-3.5-turbo-instruct, the cost is $0.02 per 1000 tokens
    ...
    def get_score(self,
        ...
        if atomic_facts is not None:
            ...
            self.print_cost_estimates(total_words, task="atomic fact generation", model="gpt-3.5-turbo-instruct"if self.af_generator_name == 'InstructGPT' else "gpt-3.5-turbo")
